...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    public static final int EDGE_LEFT = ViewDragHelper2.EDGE_LEFT;

    /**
     * Edge flag indicating that the right edge should be affected.
     */
    public static final int EDGE_RIGHT = ViewDragHelper2.EDGE_RIGHT;

    /**
     * Edge flag indicating that the bottom edge should be affected.
     */
    public static final int EDGE_BOTTOM = ViewDragHelper2.EDGE_BOTTOM;
     ...
     * fling/snap.
     */
    public static final int STATE_IDLE = ViewDragHelper2.STATE_IDLE;

    /**
     * A view is currently being dragged. The position is currently changing as
     * a result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = ViewDragHelper2.STATE_DRAGGING;

    /**
     * A view is currently settling into place as a result of a fling or
     * predefined non-interactive motion.
     */
    public static final int STATE_SETTLING = ViewDragHelper2.STATE_SETTLING;
    ...
    private ViewDragHelper2 mDragHelper;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mDragHelper = ViewDragHelper2.create(this, new ViewDragCallback());
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mScrimOpacity > 0 && drawContent
                && mDragHelper.getViewDragState() != ViewDragHelper2.STATE_IDLE) {
    ...
    private class ViewDragCallback extends ViewDragHelper2.Callback {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (mEdgeFlag == EDGE_LEFT || mEdgeFlag == EDGE_RIGHT) {
                directionCheck = !mDragHelper.checkTouchSlop(ViewDragHelper2.DIRECTION_VERTICAL, i);
            } else if (mEdgeFlag == EDGE_BOTTOM) {
                directionCheck = !mDragHelper
                        .checkTouchSlop(ViewDragHelper2.DIRECTION_HORIZONTAL, i);
