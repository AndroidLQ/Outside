...
/**
 * ViewDragHelper2 is a utility class for writing custom ViewGroups. It offers a
 ...
 */
public class ViewDragHelper2 {
    private static final String TAG = "ViewDragHelper2";
    ...
    /**
     * A Callback is used as a communication channel with the ViewDragHelper2
     ...
     * the ViewDragHelper2 with more information about the state of the parent
    ...
    public static abstract class Callback {
         ...
         * invokes one of these methods, the ViewDragHelper2 will enter
         ...
         * place and the ViewDragHelper2 will return to {@link #STATE_IDLE}.
         * </p>
         *
         ...
         * <p>
         * ViewDragHelper2 may call this method multiple times for the same view
    ...
    /**
     * Factory method to create a new ViewDragHelper2.
     *
     * @param forParent Parent view to monitor
     * @param cb        Callback to provide information and receive events
     * @return a new ViewDragHelper2 instance
     */
    public static ViewDragHelper2 create(ViewGroup forParent, Callback cb) {
        return new ViewDragHelper2(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper2 instance
     */
    public static ViewDragHelper2 create(ViewGroup forParent, float sensitivity, Callback cb) {
        final ViewDragHelper2 helper = create(forParent, cb);
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        return helper;
    }

    /**
     * Apps should use ViewDragHelper2.create() to get a new instance. This will
     ...
     * @param forParent Parent view to monitor
     */
    private ViewDragHelper2(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
     ...
     * callback's
     * {@link ViewDragHelper2.Callback#onEdgeTouched(int, int)}
     * and
     * {@link ViewDragHelper2.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link ViewDragHelper2.Callback#tryCaptureView(android.view.View, int)}
    ...
    public void captureChildView(View childView, int activePointerId) {
        if (childView.getParent() != mParentView) {
            throw new IllegalArgumentException("captureChildView: parameter must be a descendant "
                    + "of the ViewDragHelper2's tracked parent view (" + mParentView + ")");
        }
     ...
     * (to the best of the ViewDragHelper2's knowledge).
     * <p>
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_DOWN: {
                ...
                // A ViewDragHelper2 can only manipulate one view at a time.
     ...
     * {@link ViewDragHelper2.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
